...
public:
	...
	EStatusCode WriteFlattenedGlyphProgram(unsigned short inFontIndex, unsigned short inGlyphIndex, CFFFileInput* inCFFFileInput, IByteWriter* inWriter);
...
private:
	...
	EStatusCode WriteRegularOperator(unsigned short inOperatorCode);
	EStatusCode WriteStemMask(Byte* inProgramCounter);
	EStatusCode WriteCharStringOperand(const CharStringOperand& inOperand);
	EStatusCode WriteCharStringOperator(unsigned short inOperatorCode);
	EStatusCode WriteByte(Byte inValue);
	EStatusCode WriteSubrOperator(unsigned short inOperatorCode);
