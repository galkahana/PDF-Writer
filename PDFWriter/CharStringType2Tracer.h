/*
   Source File : CharStringType2Tracer.h
...
public:
	...
	PDFHummus::EStatusCode TraceGlyphProgram(unsigned short inFontIndex, unsigned short inGlyphIndex, CFFFileInput* inCFFFileInput, IByteWriter* inWriter);
