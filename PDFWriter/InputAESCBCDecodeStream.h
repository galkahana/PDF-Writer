...
class InputAESCBCDecodeStream : public IByteReader
{
public:
	InputAESCBCDecodeStream(void);
	~InputAESCBCDecodeStream(void);

	// InputAESCBCDecodeStream owns inSourceReader and will delete it on destruction.
	InputAESCBCDecodeStream(
