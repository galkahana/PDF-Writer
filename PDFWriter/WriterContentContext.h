/*
   Source File : WriterContentContext.h
...
class WriterContentContext : public AbstractContentContext
{
public:
	WriterContentContext( IByteWriter* inStream, ResourcesDictionary* inResources );
	virtual ~WriterContentContext(void);
