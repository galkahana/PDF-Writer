/*
Source File : OutputAESECBEncodeStream.h
...
class OutputAESECBEncodeStream : public IByteWriterWithPosition
{
public:
	OutputAESECBEncodeStream(void);
	virtual ~OutputAESECBEncodeStream(void);

	OutputAESECBEncodeStream(
