...
static EStatusCode TestOnlyMerge(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"TestOnlyMerge.pdf"),ePDFVersion13);
		...
		status = pdfWriter.MergePDFPagesToPage(page,
                                               BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"),singePageRange);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode TestPrefixGraphicsMerge(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"TestPrefixGraphicsMerge.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;
		...
		status = pdfWriter.MergePDFPagesToPage(page,BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"),singePageRange);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode TestSuffixGraphicsMerge(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"TestSuffixGraphicsMerge.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode TestBothGraphicsMerge(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"TestBothGraphicsMerge.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode MergeTwoPageInSeparatePhases(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"MergeTwoPageInSeparatePhases.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;
		...
		status = pdfWriter.MergePDFPagesToPage(page,BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"),firstPageRange);
		if(status != PDFHummus::eSuccess)
			break;
		...
		status = pdfWriter.MergePDFPagesToPage(page,BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"),secondPageRange);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode MergeTwoPageWithEvents(char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"MergeTwoPageWithEvents.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;
		...
		status = pdfWriter.MergePDFPagesToPage(page,BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"),twoPageRange);
		if(status != PDFHummus::eSuccess)
			break;
...
static EStatusCode MergePagesUsingCopyingContext(char* argv[])
{
	...
	do
	{
		status = pdfWriter.StartPDF(BuildRelativeOutputPath(argv,"MergePagesUsingCopyingContext.pdf"),ePDFVersion13);
		if(status != PDFHummus::eSuccess)
			break;

		PDFDocumentCopyingContext* copyingContext = pdfWriter.CreatePDFCopyingContext(BuildRelativeInputPath(argv,"BasicTIFFImagesTest.pdf"));
		if(!copyingContext)
		{
			status = PDFHummus::eFailure;
			break;
...
int MergePDFPages(int argc, char* argv[])
{
