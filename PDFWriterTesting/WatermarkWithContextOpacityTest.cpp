...
int WatermarkWithContextOpacityTest(int argc, char* argv[])
{
    PDFWriter pdfWriter;
	EStatusCode status; 
	...
	do
	{
		status = pdfWriter.StartPDF(
            BuildRelativeOutputPath(argv, "WatermarkWithContextOpacityTest.pdf"), 
            ePDFVersion14,         
        ...
        pageContentContext->SetOpacity(0.5);
