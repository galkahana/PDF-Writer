...
int TTCTest(int argc, char* argv[])
{
	PDFWriter pdfWriter;
	EStatusCode status;
	...
	do
	{
		status = pdfWriter.StartPDF(
                                    BuildRelativeOutputPath(argv,"TTCTestLucidaGrande.pdf"),
                                    ePDFVersion13,
                                    LogConfiguration(true,true,BuildRelativeOutputPath(argv,"TTCTestLucidaGrande.log")));
		...
		PDFUsedFont* fontLucidaGrande0 = pdfWriter.GetFontForFile(BuildRelativeInputPath(argv,"fonts/LucidaGrande.ttc"),0);
        ...
        PDFUsedFont* fontLucidaGrande1 = pdfWriter.GetFontForFile(BuildRelativeInputPath(argv,"fonts/LucidaGrande.ttc"),1);
